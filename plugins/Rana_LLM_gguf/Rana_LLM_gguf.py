...
class RanaLLMGGUF(LLMPluginInterface):
    context_length = 4096

    def init(self):
        # Directory where the module is located
        current_module_directory = os.path.dirname(__file__)
        model_filename = "Rana_Q5_K_M.gguf"
        ...
        if not os.path.exists(model_path):
            ...
            url = "https://huggingface.co/xiaoheiqaq/Rana-gguf/resolve/main/Rana_Q5_K_M.gguf?download=true"
